...
(function work() {
  ...
  const projects = [
    ...
    { name: 'Edu Cycle', tag: 'Full Stack', desc: 'Educational resource sharing platform enabling a circular economy of learning materials.', tags: ['Next.js', 'PostgreSQL', 'React', 'Tailwind'], link: 'https://github.com/Dan-ex-hub/Educycle', img: 'screenshots/educycle.png' },
    ...
    { name: 'Sahaayak', tag: 'MERN', desc: 'Community assistance platform connecting volunteers with people in need for social good.', tags: ['MERN', 'Socket.io', 'Maps API'], link: 'https://sahaayak-rose.vercel.app/', img: 'screenshots/sahaayak.jpg' },
