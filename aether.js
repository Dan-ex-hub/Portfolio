...
(function work() {
  ...
  const projects = [
    ...
    { name: 'GRID', tag: 'ML Platform', desc: 'A grid-based layout system and management platform with applied machine learning for modern web apps.', tags: ['React', 'Machine Learning', 'XGBoost', 'LightGBM'], link: 'https://github.com/vinitgirdhar/GRID_' },
